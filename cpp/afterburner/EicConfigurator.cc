...
ab::AfterburnerConfig ab::EicConfigurator::preset_ip6_eau_110x18() {
    ...
    // Beam charge
    cfg.ion_beam.charge = 79;
    cfg.electron_beam.charge = -1;

    // Beam mass
    cfg.ion_beam.mass = 184.009; //fix?
    cfg.electron_beam.mass = 0.000511;
...
ab::AfterburnerConfig ab::EicConfigurator::preset_ip6_hiacc_41x5() {
    ...
    // Beam charge
    cfg.ion_beam.charge = 1;
    cfg.electron_beam.charge = -1;

    // Beam mass
    cfg.ion_beam.mass = 0.938;
    cfg.electron_beam.mass = 0.000511;
...
ab::AfterburnerConfig ab::EicConfigurator::config(ab::EicBeamEnergies ion, ab::EicBeamEnergies electron, ab::EicBeamPresets beam_preset) {
    ...
    if(ion != EicBeamEnergies::E275GeV && ion != EicBeamEnergies::E110GeV && ion != EicBeamEnergies::E100GeV && ion != EicBeamEnergies::E41GeV) {
