...
ab::AfterburnerConfig ab::EicConfigurator::preset_ip6_eCu_115x9() {
    ab::AfterburnerConfig cfg;
...
ab::AfterburnerConfig ab::EicConfigurator::preset_ip6_eHe3_166x9() {
...
ab::AfterburnerConfig ab::EicConfigurator::preset_ip6_eD_130x9() {
...
ab::AfterburnerConfig ab::EicConfigurator::preset_ip6_ep_130x9() {
...
ab::AfterburnerConfig ab::EicConfigurator::preset_ip6_ep_250x9() {
...
ab::AfterburnerConfig ab::EicConfigurator::preset_ip6_eAu_100x9() {
...
ab::AfterburnerConfig ab::EicConfigurator::preset_ip6_eAu_110x9() {
    ab::AfterburnerConfig cfg;
...
ab::AfterburnerConfig ab::EicConfigurator::preset_ip6_ePb_100x9() {
...
ab::AfterburnerConfig ab::EicConfigurator::preset_ip6_ePb_110x9() {
    ab::AfterburnerConfig cfg;
...
ab::AfterburnerConfig ab::EicConfigurator::preset_ip6_hiacc_100x9() {
    ab::AfterburnerConfig cfg;
...
ab::AfterburnerConfig ab::EicConfigurator::preset_ip6_hiacc_275x9() {
    ab::AfterburnerConfig cfg;
...
ab::AfterburnerConfig ab::EicConfigurator::preset_ip6_hidiv_100x9() {
    ab::AfterburnerConfig cfg;
...
ab::AfterburnerConfig ab::EicConfigurator::preset_ip6_hidiv_275x9() {
    ab::AfterburnerConfig cfg;
...
ab::AfterburnerConfig ab::EicConfigurator::from_string(const std::string &name) {
    ...
    if(name == "ip6_eRu_115x9")   return preset_ip6_eRu_115x9();
    if(name == "ip6_eCu_115x9")   return preset_ip6_eCu_115x9();
    if(name == "ip6_eHe3_166x9")  return preset_ip6_eHe3_166x9();
    if(name == "ip6_eD_130x9")    return preset_ip6_eD_130x9();
    if(name == "ip6_ep_130x9")    return preset_ip6_ep_130x9();
    if(name == "ip6_ep_250x9")    return preset_ip6_ep_250x9();
	if(name == "ip6_eAu_100x9")   return preset_ip6_eAu_100x9();
    if(name == "ip6_eAu_110x9")   return preset_ip6_eAu_110x9();
	if(name == "ip6_ePb_100x9")   return preset_ip6_ePb_100x9();
    if(name == "ip6_ePb_110x9")   return preset_ip6_ePb_110x9();
    if(name == "ip6_hiacc_100x9") return preset_ip6_hiacc_100x9();
    if(name == "ip6_hiacc_275x9") return preset_ip6_hiacc_275x9();
    if(name == "ip6_hidiv_100x9") return preset_ip6_hidiv_100x9();
    if(name == "ip6_hidiv_275x9") return preset_ip6_hidiv_275x9();
