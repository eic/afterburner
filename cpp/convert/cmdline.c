/*
  ...
  gengetopt -N --no-version --input=hepmcconvert.ggo --include-getopt --show-required -uinputfile outputfile 
...
const char *gengetopt_args_info_usage = "Usage: convert_example [OPTIONS]... [inputfile outputfile]...";
...
const char *cmdline_parser_input_format_values[] = {"auto", "hepmc2", "hepmc3", "hpe", "root", "treeroot", "lhef" , "gz", "plugin", 0}; /*< Possible values for input-format. */
const char *cmdline_parser_output_format_values[] = {"hepmc2", "hepmc3", "hpe", "root", "treeroot", "treerootopal", "hpezeus", "dump", "dot","plugin", 0}; /*< Possible values for output-format. */
